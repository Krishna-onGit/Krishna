  ...
  return (
    ...
    >
      ...
      >
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 min-h-[280px] bg-[#FF5F1F]">
        ...
        <WobbleCard containerClassName="col-span-1 min-h-[280px] bg-[#CCFF00]">
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-3 min-h-[240px] bg-[#00F0FF]">
